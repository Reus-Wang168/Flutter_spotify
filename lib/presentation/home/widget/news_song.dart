...
import 'package:spotify/presentation/home/bloc/cubit/news_songs_cubit.dart';
  ...
  Widget _songs(BuildContext context, List<SongEntity> songs) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        String encodedArtist = Uri.encodeComponent(songs[index].artist.trim());
        String encodedTitle = Uri.encodeComponent(songs[index].title.trim());
