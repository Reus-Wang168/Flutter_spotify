...
import 'package:spotify/presentation/choose_mode/bloc/cubit/theme_cubit.dart';
                        ...
                        child: BackdropFilter(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: const Color.fromARGB(255, 21, 24, 26)
                                  .withOpacity(0.5),
            ...
            BasicAppButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (builder) => const SignupOrSigninPage()));
                },
                title: 'Get started')
          ]),
        ),
